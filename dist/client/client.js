...
cubeRotationFolder.add(cube.rotation, "x", 0, Math.PI * 2, 0.01); // Math.PI * 2 = 360 degrees (value put in radians)
...
cubeScaleFolder.add(cube.scale, "x", -5, 5, 0.2).onFinishChange(() => console.dir(cube.geometry));
cubeScaleFolder.add(cube.scale, "y", -5, 5, 0.2);
cubeScaleFolder.add(cube.scale, "z", -5, 5, 0.2);
